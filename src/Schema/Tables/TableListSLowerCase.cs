...
namespace ZeraSystems.CodeNanite.Schema
{
    ...
    {
        "Zera Systems Inc.",                    // 0
        "Return a Pluralized List of Tables (in Lowercase)",              // 1
        "Return a Pluralized List of Tables (in Lowercase). When used as part of the label of a node, it will generate either files or folders for as many tables are available "+
        "in the schema depending on whether the node is File node or a Folder node. ",                                   // 2
        "1.0",                                  // 3
        "TableListSLowerCase",                         // 4
