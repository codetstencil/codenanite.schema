...
namespace ZeraSystems.CodeNanite.Schema
{
    ...
    {
        "Zera Systems Inc.",                    // 0
        "Returns a List of Tables",              // 1
        "When used as part of the label of a node, it will generate either files or folders for as many tables are available "+
    ...
    public partial class TableList : ExpansionBase, ICodeStencilCodeNanite
    {
