...
namespace ZeraSystems.CodeNanite.Schema
{
    ...
    [CodeStencilCodeNanite(new[]
    {
        ...
        "Get the list of Foreign Key Column Names", // 1 - Title : This is the title of the Code Nanite
        "Returns a list of Foreign Key Column " +
        "Name of the passed table.",               // 2
        "1.0",                                      // 3
        "GetColumnNamesFK",                         // 4
        "ZeraSystems.CodeNanite.Schema",            // 5
        "12/13/2020",                               // 6
        "CS_COLUMN_NAMES_FK",                       // 7
        "1",                                        // 8
        "",                                         // 9
        "https://codestencil.com/documentation/how-codestencil-works"   // 10
    })]
    public partial class GetColumnNamesFK : ExpansionBase, ICodeStencilCodeNanite
    {
