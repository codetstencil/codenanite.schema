...
namespace ZeraSystems.CodeNanite.Schema
{
    ...
    [CodeStencilCodeNanite(new[]
    {
        ...
        "Get the list of SQL DBTypes",          // 1 - Title : This is the title of the Code Nanite
        "Returns a list of SQL DBTypes of the "+
        "passed table.",                            // 2
        "1.0",                                      // 3
        "GetColumnDbTypes",                        // 4
    ...
    public partial class GetColumnDbTypes : ExpansionBase, ICodeStencilCodeNanite
    {
